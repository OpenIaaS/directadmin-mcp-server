...
4. Validate IPs / usernames / domains / services / backup files with
   `security.py` — do not interpolate raw strings into paths.
   Impersonation targets go through `validate_impersonate`.
